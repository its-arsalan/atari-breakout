...
Original file is located at
    https://colab.research.google.com/drive/10bozoYElodQH5GqyBoxJxZI7xaHHDgcT
"""
...
optimizer = keras.optimizers.RMSprop(learning_rate=0.0001, clipnorm=0.99)
...
#2000000
while frame_count <= 2000000 :  # Run until solved
    ...
    np.save(history_file, episode_reward_history)
    model.save('model.h5')
